                  ...
                  <div className="profile-dropdown">
                    ...
                    {isProfileDropdownOpen && (
                      <div className="dropdown-menu">
                        <Link to="/my-account" onClick={() => setIsProfileDropdownOpen(false)}>
                          <FaUser /> My Account
                        </Link>
                        <Link to="/my-appointments" onClick={() => setIsProfileDropdownOpen(false)}>
                          <FaCalendarCheck /> My Appointments
                        </Link>
                        <button onClick={() => { onLogout(); setIsProfileDropdownOpen(false); }}>
                          <FaSignOutAlt /> Logout
                        </button>
                      </div>
                    )}
